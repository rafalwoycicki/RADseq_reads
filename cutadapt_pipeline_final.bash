...
readsP5="25M_MP_EKDL230001910-1A_HNW37DSX5_L2_1.fq.gz" # reads from P5 primer - forward
readsP7="25M_MP_EKDL230001910-1A_HNW37DSX5_L2_2.fq.gz" # reads from P7 primer - reverse
barcodes=old_barcodes_cutadapt.txt # fasta file with barcodes

echo "$iftest $qualada $qualfil $errbar $errfil $errfilanc $thr $lenada $lenfil $readsP5 $readsP7 $barcodes"
